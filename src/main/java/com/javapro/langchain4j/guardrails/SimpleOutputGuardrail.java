...
@ApplicationScoped
public class SimpleOutputGuardrail implements InputGuardrail {

    private final EvilUsageDetectionService service;

    public SimpleOutputGuardrail(EvilUsageDetectionService service) {
    ...
    public InputGuardrailResult validate(UserMessage userMessage) {
        ...
        if (result > 0.7) {
            Logger.getLogger(SimpleOutputGuardrail.class.getName()).info("!!! Attempt to create biological weapon detected !!!");
